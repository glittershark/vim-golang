...
hi def link goBraces	     Function
hi def link goParens	     Operator
hi def link goOpSymbols    Operator
hi def link goLogicSymbols Boolean
" }}}
" Highlight function names {{{
" Thanks to https://groups.google.com/d/msg/golang-nuts/z2qXo2IQipg/3yXteBIx67MJ
syn match   goFuncKeyword    "^func"
syn match   goFuncName       "\([A-Za-z_]\)\w*("he=e-1 
syn region  goFuncDefinition start="^func"ms=s+4 end="{" transparent contains=goFuncName contains=goFuncKeyword

hi def link goFuncKeyword Keyword
